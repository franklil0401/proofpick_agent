...
Create a file named `embedding_server.py` with the server implementation. You can copy this from the [local deployment guide](/docs/en/youtu-embedding/deploying-locally) or create it with the following content:
