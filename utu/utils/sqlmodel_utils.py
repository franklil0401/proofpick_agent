...
class SQLModelUtils:
    ...
    def check_db_available(cls, force_check: bool = False, cache_ttl: int = 60) -> bool:
        ...
        try:
            ...
            cls._db_available = False
            cls._last_check_time = time.time()
            logger.error(f"Database connection failed: {e}. Don't worry — If this is your first time launching the application, the local directory will be created automatically.")
            return False
