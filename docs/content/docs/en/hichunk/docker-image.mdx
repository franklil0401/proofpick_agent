...
Create a file named `utu_v1.py` with the Youtu HiChunk model implementation. You can copy this file from the downloaded `Youtu-HiChunk` directory or from the [local deployment guide](/docs/en/hichunk/deploying-locally).
...
Create a file named `registry.py` with the updated vLLM model registry. You can copy this file from the downloaded `HiChunk` directory or from the [local deployment guide](/docs/en/hichunk/deploying-locally).
